...
from src.trainer import get_criterion_cls, get_optimizer_cls, get_scheduler_cls, trainer_supervised_classification
...
def main(args: argparse.Namespace):
    ...
    save_root = os.path.join(src.config.CHECKPOINTS_DIR, folder_name)
